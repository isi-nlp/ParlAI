            ...
            <div className="hero-head" style={{ width: '850px', padding: '20px', margin: '0px auto' }}>
                ...
                <div>
                    ...
                    <ol>
                        ...
                        <li>
                            You are being asked to take part in this study because you can speak English fluently, and you are at least 18 years old. The purpose of this study is to assess the ability of artificial intelligence-based moderators ("bots") to affect online toxic behavior. Your participation in this study will last approximately 10 minutes per conversation you wish to participate in, but you will have multiple opportunities to participate. Procedures will include reading an existing partial online conversation, assuming the persona, attitude, opinion, and behavior of one of the participants in that conversation, and reacting naturally to another participant who tries to alter "your" behavior.  
                        </li>
                        <li>
